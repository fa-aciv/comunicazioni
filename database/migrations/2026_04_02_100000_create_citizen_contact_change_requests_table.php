...
return new class extends Migration
{
    ...
    {
        Schema::create('citizen_contact_change_requests', function (Blueprint $table) {
            $table->id();
            ...
            $table->index(['new_email', 'completed_at']);
        });
    }

    public function down(): void
    {
        Schema::dropIfExists('citizen_contact_change_requests');
    }
};
